...
class Appointment:
    ...
    def appointment(self, request):
        ...
        return render_template("Appointment/appointment.html", appointment=appointment)
    ...
    def updateAppointment(self, request):
        ...
        return render_template("Update/updateAppointment.html", editappointmentid=editappointmentid, editstatus=editstatus)
