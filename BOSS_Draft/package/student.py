...
class Student:
    ...
    def studentinfo(self, request):
        ...
        return render_template("Info/studentinfo.html", studentinfo=studentinfo)
    ...
    def updateStudentInfo(self, request):
        ...
        return render_template("Update/updateStudent.html", editstudentid=editstudentid, edityearlevel=edityearlevel,
