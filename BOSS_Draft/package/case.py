...
class Case:
    ...
    def caseinfo(self, request):
        ...
        return render_template("Info/caseinfo.html", caseinfo=caseinfo)
    ...
    def updateCaseInfo(self, request):
        ...
        return render_template("Update/updateCase.html", editcaseid=editcaseid, editcasedesc=editcasedesc,
                               editcasestatus=editcasestatus)
