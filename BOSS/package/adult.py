...
class AdultManager(Adult):
    def adultinfo(self, request):
        ...
        return render_template("Admin/Info/adultinfo.html", adultinfo=adultinfo)
    ...
    def updateAdultInfo(self, request):
        ...
        return render_template("Admin/Update/updateAdult.html", editemployeeid=editemployeeid,
                               editemploymentstatus=editemploymentstatus,
                               editmonthlyincome=editmonthlyincome)
