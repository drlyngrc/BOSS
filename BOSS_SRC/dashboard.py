    ...
    def dashboard(self):
        try:
            ...
            if user_info:
                ...
                address = f"Purok {user_info['Zone']}, {user_info['HouseholdNo']} {user_info['StreetName']}, {user_info['City']} City"
                ...
                return render_template("Residents/Dashboard/residenthome.html", lastname=lastname, firstname=firstname,
