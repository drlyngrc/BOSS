...
class ResidentManager(Resident):
    def residentinfo(self, request):
        ...
        return render_template("Admin/Info/residentinfo.html", residentinfo=residentinfo)
    ...
    def updateResidentInfo(self, request):
        if request.method == "POST":
            ...
            self.resident_updater.update_entity(updatebarangayid, updatecategory, updatelastname, updatefirstname,
            ...
            return redirect("/admin/residentinfo")
        ...
        return render_template("Admin/Update/updateResident.html", editbarangayid=editbarangayid, editcategory=editcategory,
                               editlastname=editlastname, editfirstname=editfirstname, editmiddlename=editmiddlename,
                               editsex=editsex, editbirthdate=editbirthdate, editbirthplace=editbirthplace,
                               editreligion=editreligion, editcivilstat=editcivilstat,
                               editcitizenship=editcitizenship, editvoterprecinct=editvoterprecinct,
