...
class AddressManager(Address):
    def addressinfo(self, request):
        ...
        return render_template("Admin/Info/addressinfo.html", addressinfo=addressinfo)
    ...
    def updateAddressInfo(self, request):
        if request.method == "POST":
            ...
            self.resident_updater.update_addressinfo(updateaddressid, updatehouseholdno, updatezone, updatestreetname,
                                                     updatecity, updateprovince)
            return redirect("/admin/addressinfo")
        ...
        return render_template("Admin/Update/updateAddress.html", editaddressid=editaddressid,
                               edithouseholdno=edithouseholdno, editzone=editzone,
                               editstreetname=editstreetname, editcity=editcity,
                               editprovince=editprovince)
