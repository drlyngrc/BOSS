...
class StudentManager(Student):
    def studentinfo(self, request):
        ...
        return render_template("Admin/Info/studentinfo.html", studentinfo=studentinfo)
    ...
    def updateStudentInfo(self, request):
        if request.method == "POST":
            ...
            self.resident_updater.update_studentinfo(updatestudentid, updateyearlevel, updateschool,
        ...
        return render_template("Admin/Update/updateStudent.html", editstudentid=editstudentid, edityearlevel=edityearlevel,
